...
export const adminApi = {
  ...
  getDubaiTours: () => fetchFromAPI('tour/dubai/tours'),

approveTour: async (tourId) => {
  return await fetchFromAPI("tour/approve", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
    body: JSON.stringify({ tourId }), // ✅ must stringify
  });
},
...
export const productsApi = {
  ...
  getProducts: (filters = {}) =>
    fetchFromAPI("products/public", {
      method: "GET",
      query: filters,
    }),

  // Get products by category
getProductById: (tourId, contractId) =>
  fetchFromAPI(`tour/dubai/tour-details`, {
    method: "POST",
