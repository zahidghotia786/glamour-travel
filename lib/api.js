...
export async function fetchFromAPI(endpoint, options = {}) {
  ...
  try {
    ...
    // Check if response was ok AND API returned success
    ...
    // Show success toast if API returned a message
...
export const adminApi = {
  ...
  updateUserStatus: (userId, isActive) =>
    fetchFromAPI(`admin/users/${userId}/status`, {
  ...
  updateUserRole: (userId, role) =>
    fetchFromAPI(`admin/users/${userId}/role`, {
      // REMOVED leading slash
      method: "PATCH",
  ...
  deleteUser: (userId) =>
    fetchFromAPI(`admin/users/${userId}`, {
      // REMOVED leading slash
      method: "DELETE",
    }),

  updateB2BUser: (userId, userData) =>
    fetchFromAPI(`admin/b2b/users/${userId}`, {
      method: "PUT",
  ...
  updateBookingStatus: (bookingId, status) =>
    fetchFromAPI(`admin/bookings/${bookingId}/status`, {
      // REMOVED leading slash
      method: "PATCH",
  ...
  categories: {
    ...
    getById: (id) => fetchFromAPI(`admin/categories/${id}`),
    ...
    update: (id, data) =>
      fetchFromAPI(`admin/categories/${id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(data),
      }),
    ...
    getStats: () => fetchFromAPI("admin/categories/stats"),
  },


  // get api product 

  getDubaiTours: () => fetchFromAPI('tourtickets/dubai-tours'),

approveTour: async ({ tourId, contractId, markupType, markupValue }) => {
  return await fetchFromAPI("tourtickets/approve", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export const b2bApi = {
  ...
  downloadVoucher: (bookingId) =>
    fetchFromAPI(`b2b/bookings/${bookingId}/voucher`, {
      // REMOVED leading slash
  ...
  getCommissions: (params = {}) => {
    ...
    const queryString = queryParams.toString();
    return fetchFromAPI(
      `b2b/commissions${queryString ? `?${queryString}` : ""}`
    ); // REMOVED leading slash
  },
};
...
export const userApi = {
  ...
  getBookings: (params = {}) => {
    ...
    const queryString = queryParams.toString();
    return fetchFromAPI(
      `users/bookings${queryString ? `?${queryString}` : ""}`
    );
  },
...
getProductById: (tourId, contractId, cityId, countryId) =>
  fetchFromAPI(`tourtickets/dubai/tour-details`, {
    method: "POST",
    body: JSON.stringify({ tourId, contractId , cityId, countryId}),
  }),


  // Get products by category
  getProductsByCategory: (categoryId) =>
    fetchFromAPI(`products/public/category/${categoryId}`, {
      method: "GET",
    }),

  // Get all categories
  getCategories: () =>
    fetchFromAPI("categories/public", {
      method: "GET",
    }),

  // Get featured products
  getFeaturedProducts: () =>
    fetchFromAPI("products/public/featured", {
      method: "GET",
    }),
};
